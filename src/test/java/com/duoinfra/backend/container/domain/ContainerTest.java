...
class ContainerTest {
    ...
    void create_status_running() {
        Container container = new Container("abc123", "192.168.0.1", 10000, "root", "pass", 1, 512, owner);
    ...
    void create_values() {
        Container container = new Container("abc123", "192.168.0.1", 10000, "root", "pass", 2, 1024, owner);
